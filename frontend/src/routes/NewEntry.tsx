...
export default function NewEntry(){
    ...
    return(
        <section className="flex justify-center flex-col w-fit ml-auto mr-auto mt-10 gap-5 bg-gray-300 p-8 rounded-md">
            ...
            <input className="p-3 rounded-md dark:text-black" type="date" name="created_at" value={(new Date(newEntry.created_at)).toISOString().split('T')[0]} onChange={handleInputChange}/>
            <input className="p-3 rounded-md dark:text-black" type="date" name="scheduled_at" value={(new Date(newEntry.scheduled_at)).toISOString().split('T')[0]} onChange={handleInputChange}/>
